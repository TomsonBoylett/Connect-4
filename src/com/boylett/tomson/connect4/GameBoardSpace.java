...
public class GameBoardSpace extends JLabel{
    public static final ImageIcon BLANK = new ImageIcon(ConnectGame.class.getResource("images/blank.png"));
    public static final ImageIcon RED = new ImageIcon(ConnectGame.class.getResource("images/red.png"));
    public static final ImageIcon YELLOW = new ImageIcon(ConnectGame.class.getResource("images/yellow.png"));
